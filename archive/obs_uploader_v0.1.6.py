...
def main_page():
    ...
    async def handle_upload(e):
        try:
            ...
            preview_container.visible = True # Now works because we removed CSS 'hidden'
    ...
    with ui.card().classes('w-full max-w-4xl mx-auto p-6 mt-10'):
        ...
        # Preview Zone
        # FIX: Removed 'hidden' class. We use .visible property now.
        with ui.column().classes('w-full gap-4') as preview_container:
            preview_container.visible = False # Start hidden programmatically
