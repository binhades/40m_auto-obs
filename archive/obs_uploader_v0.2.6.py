...
def main_page():
    ...
    def validate_and_update_ui(data, filename):
        ...
        # 1. Run Verification (Returns False and a Dictionary of errors)
        ...
        for idx, task in enumerate(data.get("schedule", [])):
            ...
            if is_valid:
                ...
                # Check if this specific row index has errors in our new dictionary
