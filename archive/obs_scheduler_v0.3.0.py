...
# --- Configuration ---
SCRIPT_VERSION = "v0.3.0"      # The version of this software (GUI)
JSON_FORMAT_VERSION = "v0.1.0" # The data format version (Backwards Compatible)
...
def download_json():
    ...
    ui.download(json.dumps({"version": JSON_FORMAT_VERSION, "schedule": clean_schedule}, indent=4).encode('utf-8'), 'schedule.json')
