...
def verify_schedule(data):
    ...
    try:
        ...
        for idx, task in enumerate(data["schedule"]):
            ...
            # We explicitly modify the dictionary here. 
            # Because python passes dicts by reference, this permanently fixes
            # the data in the Uploader before it gets saved to disk.
