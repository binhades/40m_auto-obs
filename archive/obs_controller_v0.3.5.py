...
# --- VERSION CONTROL ---
CONTROLLER_VERSION = "v0.3.5 (Init Fix)"
...
def main_page():
    ...
    def update_table():
        # CRITICAL FIX: Guard against NoneType if called before table exists
    ...
    def update_status_ui():
        ...
        # Guard against NoneType for labels/buttons
        if status_label:
    ...
    with ui.header().classes('bg-slate-800 text-white'):
        ...
        # Timer might fire before UI build is complete, but we have guards now
    ...
    # CRITICAL FIX: Only call this AFTER the table is created
    update_status_ui() 
